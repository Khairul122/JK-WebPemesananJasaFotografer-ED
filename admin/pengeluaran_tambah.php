								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" name="theform" action="pengeluaran_add.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="number" min="0" name="uang_keluar" class="form-control" required>
													</div>
												</div>
