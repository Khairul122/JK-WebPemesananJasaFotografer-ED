    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo" style="padding-top: 10px;"><a href="index.php">
              <p style="font-size: 40px; font-weight: bold;">PICT STORY</p>
            </a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:ask@menaratnt.com">pictstory@gmail.com</a>
            </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Telp : </p>
              <a href="tel:+62812-3636-6860">+6287 8878 8106</a>
            </div>
